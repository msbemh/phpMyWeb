    ...
    function html5Upload() {
    	console.log("html5Upload동작");
    	var tempFile,
    		sUploadURL;

    	sUploadURL= '/php_uploader/php/file_uploader_html5.php'; 	//upload URL
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
    	console.log("callAjaxForHTML5동작");
    ...
    function makeArrayFromString(sResString){
    	var	aTemp = [],
 		...
 		try{
			...
			console.log("sResString.indexOf(\"sFileURL\"):",sResString.indexOf("sFileURL"));
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/php_uploader/php/file_uploader_html5.php',	//샘플 URL입니다.
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/smartEditor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
